...
train_test_dict = {'1': 'train', '2': 'train', '3': 'train', '4': 'test', '5': 'test', '6': 'test'}
...
exp_dir_name = 'CNN_new_condition_'
...
def main():
    ...
    act_train, act_val = random_split(train_dataset, [train_num, val_num])
